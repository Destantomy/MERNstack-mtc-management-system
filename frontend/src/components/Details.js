...
const Details = () => {
  ...
  const getDetails = async () => {
    let result = await fetch('https://render-8iurfpx8a-destas-projects.vercel.app/api/datalog/' + id)
  ...
  const update = async (e) => {
    e.preventDefault()
      ...
      const response = await fetch('https://render-8iurfpx8a-destas-projects.vercel.app/api/datalog/' + id, {
        method: 'PUT',
